        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            ...
            <p className="text-white/60 text-lg max-w-md leading-relaxed">
              Smart categorization, real-time insights, and intelligent spending analysis — all in one platform.
            </p>

            {/* Feature pills */}
            <div className="flex flex-wrap gap-3 mt-6">
              {['AI Insights', 'Real-time Tracking', 'Smart Alerts', 'Secure P2P'].map((feature) => (
                <span
                  key={feature}
                  className="px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-sm font-medium text-white/80 border border-white/10"
                >
                  {feature}
                </span>
              ))}
